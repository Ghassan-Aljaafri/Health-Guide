                                ...
                                <div class="main-menu d-none d-lg-block">
                                    <nav dir="rtl">
                                        <ul id="navigation">
                                            ...
                                            <li><a href="system/recipe">الوجبات الصحية</a></li>
                                            <li><a href="system/healthy-food-location">أماكن توفر الوجيات الصحية</a></li>
                    ...
                    <div class="row align-items-center justify-content-center">
                        <div class="col-xl-8 ">
                            <div class="slider_text text-center">
                                <div class="text">
                                    <h3>
                                        طبق الدجاج مع الخس و البيض الرائب
                                    </h3>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        <div class="text-center mb-5">
                            <h1 style="color: black;">الوصفات </h1>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single_recepie text-center">
                            ...
                            <span>Appetizer</span>
                            <p>الزمن المستغرق : 30 دقيقة</p>
                            <a href="system/recipe" class="line_btn">المزيد</a>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single_recepie text-center">
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="recepie_info">
                            <h3 style="font-family: 'Cairo', sans-serif; color: black; ">للرياضة فوائد كثيرة للجسم من اهمها الحفاظ علي
                                الصحة </h3>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="videos_thumb">
                            <div class="big_img">
                                <img src="img/manrunnig.jpg" height="440px" width="430px" alt="">
                            </div>
                            <div class="small_thumb">
                                <img src="img/full-body-workout-.jpg" height="210px" width="180px" alt="">
                            </div>
                            <div class="small_thumb_2">
                                <img src="img/cardio-builds-muscle.jpg" height="220px" width="190px" alt="" ">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-4 col-md-6 col-lg-4">
                                <div class="footer_widget">
                                    ...
                                    <p class="newsletter_text">You can trust us. we only send promo offers,
                                    </p>
